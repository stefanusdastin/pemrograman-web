    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-lg p-2">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">
                <img src="http://localhost/pemrograman-web/pertemuan1/Ecommerce/img/logo.svg" alt="" />
            </a>
                ...
                <div class="row justify-content-center mb-3">
                    <div class="col-md-8">
                        <div class="mb-3 mt-3">
                            ...
                            <input name="username" type="text" class="form-control" type="text">
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center mb-3">
                    <div class="col-md-8">
                        <div class="mb-3 mt-3">
                            ...
                            <select name="gender" id="gender" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                ...
                <div class="row justify-content-center mb-3">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <p class="form-text">Already have an account?<a href="login-page.php">Sign In</a><br><a href="#">Forgot your password?</a></p>
                        </div>
                    </div>
                </div>
